...
const users = [
  ...
  {name: 'Josias', avaliable: false},
  {name: 'Kleber', avaliable: true}
]
...
const products = [
  ...
  {name: 'Fogão', price: 499, category: 'Eltro'},
...
const hat = new ProductWithAttributes('Chápeu', 29.99, ['Preto', 'Amarelo', 'Verde'])
